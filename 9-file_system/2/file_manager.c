...
int file_manager() {
    ...
    panes[0].main_wnd = derwin(left_wnd, (term_size.ws_row - 4), (term_size.ws_col / 2) - 2, 3, 1);
    panes[0].path_wnd = derwin(left_wnd, 1, (term_size.ws_col / 2) - 2, 1, 1);

    right_wnd = derwin(main_wnd, term_size.ws_row, (term_size.ws_col / 2), 0, (term_size.ws_col / 2));
    box(right_wnd, '|', '-');
    wmove(right_wnd, 2, 1);
    whline(right_wnd, '-', (term_size.ws_col / 2) - 2);
    panes[1].main_wnd = derwin(right_wnd, (term_size.ws_row - 4), (term_size.ws_col / 2) - 2, 3, 1);
